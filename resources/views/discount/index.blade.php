        ...
        <div class="col col-sm-8 col-md-6 col-lg-3">
            <div id="discounts">
                <div id="search-row" class="row search align-items-center mb-3">
                    <div class="col">
                        <div>
                            <form action="{{ route('discounts.index') }}" method="" class="d-flex align-items-center">
                                <input type="text" id="search" name="search" class="" placeholder="Пребарувај...">
                                <button type="submit">
                ...
                <div class="row discounts">
                    <div class="col p-0">
                        <div id="active-discounts">
                            ...
                            <div class="discount active">
                                ...
                                <div class="d-flex align-items-center actions">
                                    <a href="{{ route('discounts.edit', $discount->id) }}" class="edit">
                                        <i class='bx bx-edit edit-btn'></i>
                                    </a>
                                    <button type="button" class="delete-discount-btn" value="{{ $discount->id }}" data-bs-toggle="modal" data-bs-target="#discount-delete-modal">
                        ...
                        <div id="inactive-discounts">
                            <div class="title">
                                Архива
                            </div>
                            @foreach($archivedDiscounts as $discount)
                            <div class="discount inactive">
                                <div class="discount-name">{{ $discount->name }}</div>
                                <div class="d-flex align-items-center actions">
                                    <a href="{{ route('discounts.edit', $discount->id) }}" class="edit">
                                        <i class='bx bx-edit edit-btn'></i>
                        ...
                        <div class="modal fade" id="discount-delete-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-hidden="true">
                            <div class="modal-dialog modal-dialog-centered">
                                <div class="modal-content">
                                    <form action="{{ route("discounts.destroy") }}" method="POST">
                                        @csrf
                                        @method('DELETE')
                                        ...
                                        <div class="modal-body">
                                            <input type="hidden" name="discount" id="delete-discount-input">
...
@vite(['resources/js/discount/index/main.js', 'resources/js/alert/success-error-sweetalert.js'])
@vite(['resources/js/discount/search.js'])
